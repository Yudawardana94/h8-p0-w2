...
if( name && role === ''){
  ...
  console.log('"welcome to proxytia world, ' + name +'"\n' + '"hallo '+ role +' '+ name + ', you can attack with your weapon"')
} else if( name && role === 'priest'){
  console.log('"welcome to proxytia world, ' + name +'"\n' + '"hallo '+ role +' '+ name + ', you will help your wounded friends"')
} else if( name && role === 'wizard'){
  console.log('"welcome to proxytia world, ' + name +'"\n' + '"hallo '+ role +' '+ name + ', make a miracle that help your victory"')
} else{
